...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    #args = cms.vstring("/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.4.2/sus_sms/LO_PDF/SMS-N2N3/v1/SMS-N2N3_mN-300_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz"),
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
  ...
  PythiaParameters = cms.PSet(
    ...
    JetMatchingParameters = cms.vstring(
      ...
      '23:mMin = 0.1',
      '24:mMin = 0.1',
      'ResonanceDecayFilter:filter = on', #require at least one higgs to decay to diphotons
