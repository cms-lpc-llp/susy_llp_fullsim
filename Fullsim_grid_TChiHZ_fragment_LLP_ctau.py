...
model = "TChiHZ_ZToLL_HToBB"
process = "N2N3"
    
hBarCinGeVmm = 1.973269788e-13


xmin, xmax, xstep = 200, 200, 25
ymin, ymay, ystep = 200, 200, 25
nevt = 30 # thousand
...
for mx in range(xmin, xmax+1, xstep):
  my = mx
  if mx == 125: #scan starts at 127 GeV
      mpoints.append([127,127,nevt])
  else:
