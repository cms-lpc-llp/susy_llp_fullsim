...
# with command line options: Configuration/GenProduction/python/Fullsim_TChiHH_fragment_LLP_ctau.py --fileout file:TChiHH_fullsim_RunIIFall17wmLHEGS.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 94X_mc2017_realistic_v17 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename TChiHH_fullsim_RunIIFall17wmLHEGS_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int() -n 10
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TChiHH_fullsim_RunIIFall17wmLHEGS.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TChiHH_fullsim_RunIIFall17wmLHEGS_inLHE.root'),
